class UserStocksController < ApplicationController
  ...
  def create
    ...
    if params[:stock_id].present?
      ...
      if stock
        ...
        if stock.save
          ...
          flash[:error] = 'Ações indisponivel'
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, notice: "Ações da(o) #{@user_stock.stock.ticker} adicionada com sucesso ao seu painel!" }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'Ação removida com sucesso!' }
